...
export const getUserActivity = async (id) => {
	try {
		const res = USER_ACTIVITY.find((el) => el.userId == id);// eslint-disable-line
		return res;
	} catch (e) {
		console.log(e);
	}
...
export const getUserAverageSessions = async (id) => {
	try {
		const res = USER_AVERAGE_SESSIONS.find((el) => el.userId == id);// eslint-disable-line
		return res;
	} catch (e) {
		console.log(e);
	}
...
export const getUserPerformance = async (id) => {
	try {
		const res = USER_PERFORMANCE.find((el) => el.userId == id);// eslint-disable-line
		return res;
	} catch (e) {
		console.log(e);
	}
